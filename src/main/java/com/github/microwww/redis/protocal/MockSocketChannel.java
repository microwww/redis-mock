...
public class MockSocketChannel extends SocketChannel {
    ...
    public MockSocketChannel(SocketAddress remoteAddress) {
        super(null);
    ...
    public MockSocketChannel recorder(ByteBuffer buf) {
        this.recorder=buf;
        this.bytes_to_write=buf.capacity();
        return this;
    }
    ...
    public void clearRecorder() {
        recorder.clear();
        bytes_to_write = recorder.capacity();
    }
    ...
    public int read(ByteBuffer dst) throws IOException {
        int read=0;
        while(dst.hasRemaining() && recorder.hasRemaining()) {
            dst.put(recorder.get());
            read++;
        }
